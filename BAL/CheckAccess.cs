...
namespace ResourceManagementSystem.BAL
{
    public class CheckAccess : ActionFilterAttribute, IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext filterContext)
        {
            ...
            if (filterContext.HttpContext.Session.GetInt32("OrganizationID") == null || filterContext.HttpContext.Session.GetString("AccessLevelName") == null || filterContext.HttpContext.Session.GetString("EmployeeEmail") == null)
            {
